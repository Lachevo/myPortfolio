...
const RECRUITER_SIGNALS = [
  {
    ...
    label: "Best fit",
    value: "AI product, backend, and full-stack teams",
  },
  {
    icon: BadgeCheck,
    label: "Strength",
          ...
          <div>
            ...
            <BlurFade delay={D * 3} blur="0px" yOffset={8}>
              <p className="mt-6 max-w-3xl text-base leading-8 text-muted-foreground sm:text-lg">
                I help teams turn complex technical ideas into shipped products: from LLM workflows and full-stack apps to system architecture and product delivery.
              </p>
            </BlurFade>
            ...
            <BlurFade delay={D * 5} blur="0px" yOffset={8}>
              <div className="mt-8 flex flex-wrap items-center gap-3">
                ...
                <Link
                  href={RESUME_PATH}
                  download
                  className="inline-flex items-center gap-2 rounded-full bg-emerald-500 px-5 py-3 text-sm font-bold text-white shadow-lg shadow-emerald-500/15 transition-transform hover:-translate-y-0.5"
                >
                  Download Resume
          ...
          {DATA.education.map((edu, id) => (
            <BlurFade key={edu.school} delay={D * (id * 0.35 + 1)} blur="0px" yOffset={6} inView>
              <ResumeCard
                ...
                title={edu.school}
                subtitle={edu.degree}
                period={edu.end ? `${edu.start} – ${edu.end}` : edu.start}
            ...
            <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
              <div>
                ...
                <p className="mt-5 max-w-2xl text-sm leading-7 text-muted-foreground">
                  I&apos;m available for full-time roles, contract builds, and technical consulting across AI engineering, full-stack, and product delivery.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
                ...
                <Link
                  href={RESUME_PATH}
                  download
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-emerald-500 px-6 py-3 text-sm font-bold text-white transition-transform hover:-translate-y-0.5"
                >
                  Download Resume
                  <FileDown className="size-4" />
                </Link>
